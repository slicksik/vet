...
const Home: React.FC = () => {
  ...
  const handlePopularSearch = (term: string) => {
    ...
    navigate(
      `/search?q=${encodeURIComponent(term)}&location=${encodeURIComponent(location)}`,
    );
    setIsSearchFocused(false);
  };
  ...
  const handleUseLocation = async () => {
    try {
      ...
      navigate(
        `/search?lat=${coords.latitude}&lng=${coords.longitude}&q=${encodeURIComponent(searchTerm)}`,
      );
      setIsSearchFocused(false);
    } catch (error) {
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-white">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div
            className="absolute left-0 bottom-0 -ml-20 -mb-20 w-[400px] h-[400px] bg-primary-200 rounded-full blur-3xl opacity-30 animate-pulse"
        ...
        <div className="max-w-7xl mx-auto">
          <div
            className={`relative pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32 pt-20 px-4 sm:px-6 lg:px-8 ${isSearchFocused ? "z-50" : "z-10"}`}
          >
            <main className="mt-10 mx-auto max-w-7xl sm:mt-12 md:mt-16 lg:mt-20 xl:mt-28">
              <div className="sm:text-center lg:text-left animate-fade-in-up relative z-50">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl mb-6">
                  ...
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-primary-700 xl:inline">
                ...
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 leading-relaxed">
                  Connect with top-rated veterinarians in your area. Book
                  appointments instantly and manage your pet's health with ease.
                </p>
                ...
                <div className="mt-8 sm:mt-12 relative">
                  <form onSubmit={handleSearch} className="relative z-50">
                    ...
                    <div
                      className={`absolute top-full left-0 right-0 mt-2 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 origin-top max-h-[60vh] overflow-y-auto ${
                        isSearchFocused
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-4 pt-4 border-t border-gray-100">
                          ...
                          >
                            ...
                            Χρησιμοποίησε την τρέχουσα τοποθεσία μου
                          </button>
                        </div>
                      </div>
                    </div>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 relative">
          ...
          <div
            className="absolute bottom-1/3 left-20 md:left-32 animate-float bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 max-w-[200px] transform -rotate-2 hover:scale-105 transition-transform duration-300 hidden sm:block"
      ...
      <div className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-base text-primary-600 font-bold tracking-wide uppercase bg-primary-100 inline-block px-4 py-1.5 rounded-full mb-4">
              What is Vetify?
            </h2>
            <p className="text-4xl font-extrabold text-gray-900 sm:text-5xl tracking-tight">
              Fast response. <br />
              <span className="text-primary-600">
                Best available veterinarians.
              </span>
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
              We've reimagined veterinary care to be faster, simpler, and more
              reliable for you and your pets.
            </p>
          </div>
          ...
          <div className="space-y-24">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  When your pet needs help, every minute counts. Our platform
                  instantly connects you with available veterinarians in your
                  area. No more waiting on hold or leaving voicemails.
                </p>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
              ...
              <div className="w-full lg:w-1/2">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-8">
                  We verify every veterinarian on our platform to ensure your
                  pet receives the highest standard of care. Read reviews from
                  other pet owners and choose with confidence.
                </p>
                <ul className="space-y-4">
                  {[
