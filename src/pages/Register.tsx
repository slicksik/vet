                ...
                <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    <div className="mb-6 grid grid-cols-2 gap-4">
                        <button
                            ...
                            className={`flex items-center justify-center px-4 py-3 border rounded-lg text-sm font-medium transition-colors ${role === 'user'
                        ...
                        <button
                            type="button"
                            onClick={() => setRole('vet')}
                            className={`flex items-center justify-center px-4 py-3 border rounded-lg text-sm font-medium transition-colors ${role === 'vet'
                                ? 'border-indigo-600 text-indigo-600 bg-indigo-50'
                                : 'border-gray-300 text-gray-700 bg-white hover:bg-gray-50'
                                }`}
                        >
